...
public function __construct(){
    ...
    if(!$this->session->userdata('logged_in')){
        $this->session->set_flashdata('no_access','you are not allowed to log in');
        redirect('home/index');
    }

}
public function display($project_id){
        $data['completed_tasks']=$this->project_model->get_project_task($project_id,false);
        $data['not_completed_tasks']=$this->project_model->get_project_task($project_id,true);
